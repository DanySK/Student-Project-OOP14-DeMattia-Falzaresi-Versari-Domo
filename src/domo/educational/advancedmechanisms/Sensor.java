 ...
 *
 *This is the generic Sensor class we already used but in addition we added the "Type" of the sensor,
 *in this implementation we decided to use a "String" to define the sensor type.
 */
...
public class Sensor {
	...
	/**
	 * Constructor of this class accept this parameters.
	 * @param sName Name of the sensor
	 * @param sId Id of the sensor
	 * @param sType Type of the sensor
	 */
	public Sensor(final String sName, final int sId, final String sType) {
		this.id = sId;
		this.type = sType;
		this.name = sName;
		this.alert = false;
